...
const ROLE_PERMISSIONS = {
  ...
  [ROLES.SUPPORT]: [PERMISSIONS.MANAGE_USERS, PERMISSIONS.MANAGE_DISPUTES, PERMISSIONS.MANAGE_REVIEWS, PERMISSIONS.VIEW_DASHBOARD, PERMISSIONS.VIEW_REPORTS],
  [ROLES.FINANCE]: [PERMISSIONS.MANAGE_PAYMENTS, PERMISSIONS.VIEW_REPORTS, PERMISSIONS.MANAGE_VOUCHERS, PERMISSIONS.MANAGE_ORDERS, PERMISSIONS.VIEW_DASHBOARD],
};
