...
const allowAdminOrSupport = (req, res, next) => {
...
router.get(
  "/disputes",
  authorize(PERMISSIONS.MANAGE_DISPUTES),
  getAllDisputesAdmin,
);
router.put(
  "/disputes/:disputeId",
...
router.get(
  "/orders/:orderId",
  authorize(PERMISSIONS.MANAGE_ORDERS),
  getOrderDetailsAdmin,
);
router.put(
...
router.get(
  "/reviews",
  authorize(PERMISSIONS.MANAGE_REVIEWS),
  getAllReviewsAdmin,
);
router.delete(
  "/reviews/:id",
...
router.get(
  "/vouchers/:id",
  authorize(PERMISSIONS.MANAGE_VOUCHERS),
  getVoucherById,
);
router.put(
  "/vouchers/:id",
